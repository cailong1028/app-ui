import { otherRoute } from '@/router/router';
...
const appStore = {
  ...
  mutations: {
    ...
    setOpenedList(state) {
      state.pageOpenedList = localStorage.pageOpenedList ? JSON.parse(localStorage.pageOpenedList) : [otherRoute.children[0]];
    },
